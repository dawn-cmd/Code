...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    public static boolean test1() {
        ...
        // add elements in RBtree
        int[] numbs = {1, 9, 2, 8, 3, 7, 4};
        for (int num: numbs)
            test.insert(num);
        // test left rotate
        test.rotate(test.root.context[2], test.root);
        return test.toInOrderString().equals("[ 1, 2, 3, 4, 7, 8, 9 ]") &&
                test.toLevelOrderString().equals("[ 9, 1, 2, 8, 3, 7, 4 ]");
    }
    ...
    public static boolean test2() {
        ...
        RedBlackTree<Integer> test = new RedBlackTree<>();
        // add elements in RBTree
        int[] numbs = {4, 2, 8, 1, 3, 7, 9};
        for (int num: numbs)
            test.insert(num);
        // test right rotate
        test.rotate(test.root.context[1], test.root);
        return test.toInOrderString().equals("[ 1, 2, 3, 4, 7, 8, 9 ]") &&
                test.toLevelOrderString().equals("[ 2, 1, 4, 3, 8, 7, 9 ]");
    }
    ...
    public static boolean test3() {
        ...
        try {
            ...
            for (int num: numbs)
                test.insert(num);
            // test right rotate
            test.rotate(test.root, test.root.context[1]);
